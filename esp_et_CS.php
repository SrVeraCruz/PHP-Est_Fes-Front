...
<body class="body">
  ...
  <main class="main">
    ...
    <a href="#cs" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    
    <section class="section" id="cs">
      <div class="headline">
        <h1>Espace Etudiants</h1>
        <h2>Les calendries des semaines au titre de l'année univérsitaire 2022-2023</h2>
      </div>
      <h1>EST-Fes <i class="fa-solid fa-graduation-cap"></i></h1>
      <div class="box-container">
        <div class="box">
          <a href="./filieres/esp_et_cs1.pdf">Premières années</a>
        </div>
        <div class="box">
          <a href="./filieres/esp_et_cs2.pdf">Deuxièmes années</a>
        </div>
        <div class="box">
          <a href="./filieres/esp_et_cs_lp.pdf">Licences Profissionnelle</a>
        </div>
      </div>
    </section>
