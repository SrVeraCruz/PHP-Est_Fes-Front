...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#gp" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Depertement start -->
    <section class="section depertements section-mixins" id="gp">
      <div class="headline">
        <h1>Département</h1>
      ...
      <div class="boxContainer">
          ...
          <div class="box-content">
            <div>
              ...
              <div>
                <p>IRAQUI SAMIR</p>
                <p>JAWAB FOUAD</p>
                <p>ALAOUI ISMAILI ABDERRAHMAN</p>
                <p>BOUKLATA AHMED</p>
              </div>
            </div>
            <div>
              <h3>PH</h3>
              <div>
                <p>OUDDASSER ABDERRAHMANE</p>
                <p>MADHAT FATIMA ZAHRA</p>
                <p>ARIF JABIR</p>
              </div>
            </div>
            <div>
            ...
            <div>
              <h3>P Ens Second Qualif</h3>
              <div>
                <p>JERBOUI ZAHIA</p>
                <p>EL HASSANI SOUAAD</p>
                <p>MOUMNI SOUHAIL</p>
              </div>
            </div>
          </div>
        ...
        <div class="box">
          ...
          <div class="box-info">
            <p>Date de Création: <span>1992</span></p>
            <p>Chef De Département: <span>Alaoui Ismaili Abderrahmani</span></p>
            <p>Email: <a href="mailto:stg@usmba.ac.ma">stg@usmba.ac.ma</a></p>
          </div>
        </div>
      </div>
    </section>
