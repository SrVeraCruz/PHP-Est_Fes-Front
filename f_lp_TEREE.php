...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Technologies Des Energies Renouvables et de L'Efficacité Energétique(TEREE)</a></li>
                  </ul>
                </div>
              </li>
            </ul>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#lp_teree" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="lp_teree">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>LP - Technologie de Energies Renouvables et Efficacité Energétique</h2>
      </div>
      <div class="boxContainer">
        ...
        <div class="box">
          ...
          <div class="box-content">
            <p>
              <span>L'ojectif principal</span> de cette formation est de développer chez l'étudiant une expertise technique <span>dans le domaine des énérgies renouvelables et de l'efficacité énergétique</span> avec une emphase sur les technologies utilisés dans l'industrie correspondante. L'étudiant aura acquis les connaissances requises pour oeuvrer au sein des entreprises de développement de projets de production électrique à partir de ressources renouvelables et sera capable d'entreprendre des actions visant l'amélioration de l'éffcacité énergétique dans les processus industriels et dans le bâtiment...
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/LPTEREE.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
