...
<head>
  ...
  <title>Conseil-Ecole CS | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#cc_cs" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Commission-Conseil start -->
    <section class="section depertements section-mixins" id="cc_cs">
      <div class="headline">
        <h1>Conseil</h1>
        <h2>Conseil de Scientifique</h2>
      </div>
      <div class="boxContainer">
        ...
        <div class="box">
          <div class="titre-container">
            <h2>Membres Désignés</h2>
          </div>
          <div class="box-content">
            <div>
              <h3>PES</h3>
              <div>
                <p>Mr BOUKLATA AHMED</p>
                <p>Mme LAKHLIAI ZAKIA</p>
              </div>
            </div>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <div>
              <h3>PES</h3>
              <div>
                <p>Mr BENTAMA JILALI</p>
                <p>Mr HERROU BRAHIM</p>
                <p>Mr BOUTAHARI SAID</p>
              </div>
            </div>
            <div>
              <h3>PH</h3>
              <div>
                <p>Mme LAIRINI SANAE</p>
              </div>
            </div>
          </div>
        </div>
