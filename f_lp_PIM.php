...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Production Industrielle(PIP/PIM)</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#lp_pim" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="lp_pim">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>LP -  Prodution Industrielle</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>D'une durée totale d'une année universitaire, La Licence professionnelle
              semestres S5 et S6.
            </p>
            <p>
              Les lauréats ont la capacité de prendre en compte	les	problématiques d' Environnement dès	la phase de conception. Les métiers préparés sont, entre autres, Concepteur C.A.O. en Bureau d'Etudes Assistant ingénieur simulations et calculs Assistant ingénieur en C.F.A.O, Bureau des Méthodes et service Métrologie et Contrôle Assistant ingénieur en service Qualité, Assistant chef de projet intégré pour les PME-PMI Intégration C.A.O. des savoir-faire métiers	et	formalisation	des connaissances.
            </p>
            <p>
              Cette formation permettra également, à ceux qui le souhaitent, la poursuite de leurs études dans les filières (Master ou cycle ingénieur) des écoles d'ingénieur, dans les facultés des sciences ou dans les facultés des sciences et techniques.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Les entreprises d'aujourd'hui ont besoin d'une équipe de spécialistes qui managent des projets industriels faisant appel à des domaines de compétences pluridisciplinaire. Ce besoin nous a conduits à la mise en place de la licence professionnelle PIM-PIP, à l'EST de Fès, vise à former des responsables techniques de l'industrie et du secteur productif capables de maîtriser et mettre en œuvre les nouveaux outils technologiques et méthodologiques dans les PME, de gérer des projets industriels et de conduire des équipes.
            </p>
            <p>
              La licence professionnelle PIM-PIP se propose de compléter la formation des techniciens supérieurs possédant une spécialité de base centrée sur la conception et la fabrication mécanique, l'électronique et l'automatique pour leur apporter les connaissances technologiques transversales essentielles dans un contexte de la conception et la fabrication intégrée des systèmes complexes automatisés (option 1), aussi réaliser des maquettes numérique et des prototype réels (option 2)...
              </span>
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/LPPIM.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
