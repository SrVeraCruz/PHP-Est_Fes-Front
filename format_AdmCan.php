...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#format_ac" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Formaton start -->
    <section class="section filiere section-mixins" id="format_ac">
      <div class="headline">
        <h1>Formation</h1>
        <h2>Admission et Candidature</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>L'admission en première année des EST est ouverte aux titulaires du baccalauréat de l'enseignement secondaire, ou d'un diplôme reconnu équivalent dans les spécialités requises pour la filière souhaitée, comme le montre les annexes 1 et 2 de la circulaire ministérielle المذكرة الوزارية .
            </p>
            <p>
              L'EST est un établissement à accès régulé, l'admission s'effectue sur une sélection basée sur les notes obtenues au baccalauréat selon la formule suivant: (75% note national +25% regional)*coefficient de pondération ,relative au type de Bac et la filière choisie.
            </p>
            <p>
              La procédure de candidature à l'EST DE Fes se fait à travers la plateforme TAWJIHI.MA منصة التسجيل
            </p>
            <div class="box-info">
              <a href="./filieres/EST_2021-2022_VF.pdf" class="btn">Plus info <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
        </div>
      </div>
