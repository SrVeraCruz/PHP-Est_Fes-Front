...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#eLearnLogin" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Suivi start -->
    <section class="section connexion-style eLearning" id="eLearnLogin">
      ...
      <div class="boxContainer">
        ...
        <div class="form-container">
          ...
          <form action="./testUserLogin.php" method="POST">
            <div class="form-box">
              ...
              <a href="#" class="forgotPass">Nom d'utilisateur ou mot de passe oublié?</a>
            </div>
            ...
            <a href="./ElearningRegister.php" class="registerBtn">Vous n'avez pas de compte ? <span>Enregistrer</span></a>
