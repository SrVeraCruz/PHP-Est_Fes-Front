...
<title>Contact | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#contact" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    ...
    <section class="section contact" id="contact">
      ...
      <div class="boxContainer">
        ...
        <div class="box">
          <h2>Tel</h2><span>:</span>
          <p>+212 5 35 60 05 84</p>
        </div>
        <div class="box">
          <h2>Fax</h2><span>:</span>
          <p>+212 5 35 60 05 88</p>
        </div>
        <div class="box">
        ...
        <div class="box">
          ...
          <a href="https://www.est-usmba.ac.ma">www.est-usmba.ac.ma</a>
          <p></p>
        </div>
        <div class="box">
          <h2>Adresse</h2><span>:</span>
          <p>المدرسة العليا للتيكنولوجيا ص ب 2427 طريق إيموزار 30000 فاس</p>
        </div>
      </div>
    </section>
    <!-- Section Contact end -->
