...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Informatique Décisionnelle</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_id" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_id">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Informatique Décisionnelle</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>La formation DUT en <span>Informatique Décisionnelle</span> a pour mission de transmettre à ses lauréats des compétences
              techniques et etier dans  
              le secteur Informatique a savoir: <span>
              Les banques et les assurances
              Les sociétès d'études et de services
              Les centres de recherches publics et privés
              Les collectivités, administrations
              La santé et lindustrie pharmaceutique
              L'industrie</span>...
              
            </p>
            <p>
              <span>La formation DUT Informatique Décisionnelle</span> est organisée autour de <span>compétence en Informatique Décisionnelle</span> complété par des connaissances générales permettent aux étudiants une insertion professionnelle immédiate, ou une vers d'autres l'enseignement supérieur.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Former des techniciens en <span>statistique décisionnelle, en informatique et en traitement de l'information</span>. Aborder tous les aspects des métiers de l'ingenierie des données: <span>Collecte, administration, exploitation et valorisation des données</span>. Permettre de jouer le rôle d'interface entre la <span>direction générale des entreprises et des services opérationnels</span>.
            </p>
            <p>
              Permettre d'accéder à une connaissance de l'entreprise et d'acquérir àtravers un projet et des stages une expériance professionnelle.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/ID.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
