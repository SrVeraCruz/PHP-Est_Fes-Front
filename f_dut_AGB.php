...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Agroalimentare et Génie Biológique</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_agb" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_agb">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Agroalimentare Et Génie Biológique</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Les titulaires du DUT <span>Génie biologique</span> peuvent  
              intégrer plusieurs secteurs industriels dont <span>
              contrôle-qualité, diététique, pharmaceutiques, agronomiques, biotechnologique et environnement</span>...
              Il peut exercer son activité dans les domaines de la <span>conduite des procédés</span>, de <span>l'analyse biochimique</span> et <span>microbioloique</span>
              La formation met l'accent sur :
              La maîtrise des différentes méthodes d'analyses biologiques et biochimiques.
            </p>
            <p>
              L'impact des différentes molécules intervenant dans les aliments.
              L'amélioration de la qualité des produits notaments dans le domaine de l'hygiène.
              La mise en accord des décisions avec les réglementations en vigueur, le fonctionn ment de l'entreprise et des principes de  
        ...
        <div class="box">
          ...
          <div class="box-content">
            <p>
              La filière <span>"Agroalimentaire et génie biologique"</span> forme des techniciens supérieurs maitrisant un large spectre de connaissances et de compétences dans le domaine de <span>l'agroalimentaire</span>.
              Elle permet l'insertion des lauréats dans les differentes industries agroalimentaires. Ces dernières, constituent au Maroc, le premier secteur d'activité industriel avec 30% de la valeur ajoutée et 12 % de l'emploi permanent.
        ...
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/AGB.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
