...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Réseaux et Télècommunications</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_rt" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_rt">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Réseaux et Rélecoms</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Le diplomé de la filière <span>Réseaux et Rélecoms</span> a essentiellement pour vocation de travailIer comme technicien dans
              les domaines: <span>Administrateur (trice) de réseau;   
                Développeur (euse) d'applications mobiles
                Hot liner:
                Informacien (enne) industriel (elle);
                Responsable micro;
            ...
            <p>
              ...
              Le cursus de formation de la filière <span>Réseaux et Rélecoms</span>, comportant un ensemble de modu acquérir à l'étudiant des connaissances, saires à la poursuite des études en: <span>Licences Professionelles</span> - <span>Ecoles d'Ingenieurs</span>.
        ...
        <div class="box">
          ...
          <div class="box-content">
            <p>
              La filière <span>Réseaux et Rélecoms</span>, organisée en quatre semestres est sanctionnée par un diplôme Universitaire de Technoligie <span>(DUT)</span>. Cet enseignement a pour objectif de
              former des techniciens supérieurs de <span>
                haut
                niveau en 2 ans
              </span>, capables d'occuper des
              emplois clés dans le secteur des Télécoms
              et des nouvelles Technologies de traite-
              ment de l'information.
              C'est une formation à large spectre
              couvrant les domaines de:
              
            </p>
            <ul>
              <li><p>Réseaux Informatiques;</p></li>
              <li><p>Réseaux Télephoniques;</p></li>
              <li><p>Télécommunication;</p></li>
              <li><p>Hyperfeéquences et Lignes de Transmis-sion;</p></li>
              <li><p>L'Informatique : Programmation & Simulation;</p></li>
            </ul>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/RT.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
