...
<body class="body">
  ...
  <main class="main">
    ...
    <a href="#accuil" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>

    <section class="accuil" id="accuil">
      <div class="boxContainer">
        <div class="slideImg">
          <div class="imgBox">
            <img src="./img/est_centre_conference.jpg" alt="est_centre_conference">
            <h1>Bienvenu EST de Fés</h1>
          </div>
          <div class="imgBox">
            <img src="./img/est_entre.jpg" alt="est_centre_conference">
            <h1>L'entre de EST Fés</h1>
          </div>
          <div class="imgBox">
            <img src="./img/est_guardin.jpeg" alt="est_centre_conference">
            <h1>L'Administration</h1>
          </div>
          <div class="imgBox">
            <img src="./img/est_park.jpeg" alt="est_centre_conference">
            <h1>Notre Gardin</h1>
          </div>
        </div>
      </div>
    ...
    <section class="services" id="services">
      ...
      <div class="boxContainer">
        <div class="mainBox">
          <div class="content">
            <div class="box">
              <img src="./img/est_espace_etudiat.jpeg" alt="est_etudiant">
            ...
            <div class="box">
              <img src="./img/est_enseignants.png" alt="est_enseignants">
              <div class="contentBox">
                <h3>EE</h3>
            ...
            <div class="box">
              <img src="./img/est_conceil.webp" alt="est_conceil">
              <div class="contentBox">
                <h3>CC</h3>
            ...
            <div class="box">
              <img src="./img/est_recrutement.jpg" alt="est_recrutement">
              <div class="contentBox">
                <h3>CR</h3>
          ...
          <div class="slide2">
            <div class="imgBox2">
              <img src="./img/slide2_est_biblio.png" alt="est_biblio">
            </div>
            <div class="imgBox2">
              <img src="./img/slide2_est_diplome.png" alt="est_diplome">
            </div>
            <div class="imgBox2">
              <img src="./img/slide2_est_espri.png" alt="est_espri">
            </div>
            <div class="imgBox2">
              <img src="./img/slide2_est_formation.png" alt="est_formation">
            </div>
            <div class="imgBox2">
              <img src="./img/slide2_est_formationpro.png" alt="est_formationpro">
            </div>
            <div class="imgBox2">
              <img src="./img/slide2_est_reussite.png" alt="est_reussite">
            </div>
            <div class="imgBox2">
              <img src="./img/slede2_est_stage.png" alt="est_stage">
            </div>
          </div>

          <div class="content">
            <div class="box">
              <img src="./img/est_formation.jpg" alt="est_formation">
              <div class="contentBox">
                <h3>FC</h3>
            ...
            <div class="box">
              <img src="./img/est_note.png" alt="est_note">
              <div class="contentBox">
                <h3>CNR</h3>
            ...
            <div class="box">
              <img src="./img/est_contact_us.png" alt="est_messagerie">
              <div class="contentBox">
                <h3>MES</h3>
    ...
    <section class="about" id="about">
      ...
      <div class="boxContainer">
        <div class="box">
          <img src="./img/est_logo_mobile2.png" alt="est_logo">
          ...
          <div class="content">
            <div class="contentBox">
              <div class="boxNews__image">
                <img src="./img/est_carte_bank.jpg" alt="carte_bank">
                <a href="#"></a>
              </div>
            ...
            <div class="othersNews">
              <div class="contentBox">
                <div class="boxNews">
                  <div class="boxNews__image">
                    <img src="./img/est_contact_us.png" alt="est_contact_us">
                    <a href="#"></a>
                  </div>
                  <div class="boxNews__info">
                    <span>19 octobre 2022</span>
                ...
                <div class="boxNews">
                  <div class="boxNews__image">
                    <img src="./img/est_emplois.jpeg" alt="est_contact_us">
                    <a href="#"></a>
                  </div>
                  <div class="boxNews__info">
                    <span>19 octobre 2022</span>
                ...
                <div class="boxNews">
                  <div class="boxNews__image">
                    <img src="./img/est_programePM.jpg" alt="est_contact_us">
                    <a href="#"></a>
                  </div>
                  <div class="boxNews__info">
                    <span>19 octobre 2022</span>
    ...
    <!--  Section video EST start -->
    <section class="aboutVideo" id="aboutVideo">
      <img src="./img/est_entre.jpg" alt="est_entre">
      <div class="boxContainer">
        <div class="box">
          <a href="https://www.youtube.com/watch?v=2qEZBot3IFg" target="_blank"><img src="./img/player_video.png" alt="player_video"></a>
    ...
    <section class="newsEvents" id="newsEvents">
      <div class="boxContainer">
        <div class="box">
          <div class="titre">
        ...
        <div class="box">
          <div class="inscrireEst">
            <img src="./img/est_inscrire_bg.jpg" alt="est_inscrire">
            <div class="inscrireEstBox">
              <img src="./img/icon-envelope.png" alt="icon-envelope">
              <div class="text">
    ...
    <section class="searchCours" id="searchCours">
      <div class="boxContainer">
        <img src="./img/est_chercherCours.jpg" alt="est_chercherCours">
        <div class="searchBox">
