...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Maintenance Electroniques Des Equipements Biomedicaux(MEEB)</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#lp_meeb" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="lp_meeb">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>LP - Maintenance Electronique des Equipements Biomédicaux</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            ...
            <p>
              Des modules de tronc commun et de spécialité, sont dispensés tout au long de l'année. <span>Un stage dans l'enterprise est obligatoire au cours du 6ème semestre</span>. Le stage a pour objectif permetre a l'etudiant d'entrer en contact avec	monde socioprofessionnel...
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              La mise en place d'une <span>licence professionnelle "Maintenance Electronique des Equipements Biomédicaux"</span> à l'EST de Fès, permettra de former des cadres comme: Responsable technique de la maintenance, de l'approvisionnement et de la sécurité des équipements biomédicaux, Responsable technico-commercial du service après-vente.
            </p>
            <p>
              Les étudiants issus de cette formation de Licence professionnelle seront capables:
              <span>
                d'assurer la maintenance préventive des équipements biomédicaux. d'assurer la maintenance corrective des équipements biomédicaux. d'assister le personnel médical sur le plan technique.
                de mettre en oeuvre les équipements médicaux disponibles en milieu hospitalier.
              </span>
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/LPMEEB.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
