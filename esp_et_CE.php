...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#ce" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Contact start -->
    <section class="section contact" id="ce">
      <div class="headline">
        <h1>Cours Etudiant</h1>
        <h2>Cours Etudiant</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          <a href="./404.html">
            <h2>Mr Lahsini</h2><span>:</span>
            <p>TRANSFERT DE CHALEUR ET TECHNOLOGIE DE TRANSFERT DE CHALEUR</p>
          </a>
        </div>
        <div class="box">
          <a href="./404.php">
        ...
        <div class="box">
          <a href="./404.php">
            <h2>Mr RABI</h2><span>:</span>
            <p>Régulation industrielle -> Filières AGB, GTE, GP</p>
          </a>
        </div>
        <div class="box">
          <a href="./404.php">
        ...
        <div class="box">
          <a href="./404.php">
            <h2>Mr KHATORY</h2><span>:</span>
            <p>COURS AUTOMATISME</p>
          </a>
        </div>
        <div class="box">
          <a href="./404.php">
            <h2>Mr KHATORY</h2><span>:</span>
            <p>COURS ALGORITHME</p>
          </a>
        </div>
        <div class="box">
          <a href="./404.php">
        ...
        <div class="box">
          <a href="./404.php">
            <h2>Mr OMOR</h2><span>:</span>
            <p>STRUCTURE DE DONNEES</p>
          </a>
        </div>
      </div>
    </section>
