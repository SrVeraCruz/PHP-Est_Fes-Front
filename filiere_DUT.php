...
<head>
  ...
  <title>Filiere DUT | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <!-- Section Filiere DUT start -->
    <a href="#f_dut" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    
    <section class="section mix_filiere" id="f_dut">
      <div class="headline">
        <h1>Filiere</h1>
        <h2>DUT</h2>
      </div>
      <h1>Diplome Universitaire de Technologie</h1>
      <div class="box-container">
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_GMP.html">Génie Mécanique et Productique</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_GE.html">Génie Électrique</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_RT.html">Réseaux et Télècommunications</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_GP.html">Génie des Procédés</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_AGB.html">Agroalimentare et Génie Biológique</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_GIM.html">Génie Industiel et Maintenance</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_INFO.html">Informatique</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_SE.html">Système Embarqués</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_ID.html">Informatique Décisionnelle</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_GTE.html">Génie Thermique et Energétique</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_TM.html">Techniques de Managment</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_GRH.html">Gestion de Ressources Humaines</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_TGC.html">Techniques de Gestion Commerciale</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_dut_GLT.html">Gestion Logistique et Transport</a>
          </div>
          <p>Diplome Universitaire</p>
        </div>
      </div>
