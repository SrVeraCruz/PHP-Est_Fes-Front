...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Techniques de Gestion Commerciale</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_tgc" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_tgc">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Techniques de Gestion Commerciale</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Les Techniciens Supérieurs en <span>Techniques de gestion Commerciale</span> formés pour occuper les postes suivants: <span>Chef de 
              rayon, responsable de secteur, technico-commercial, chargé de clientèle, assistant marketing, chargé d'études, conseiller financier, chargé de clientèle, Phoning et gestion des réclamations clients</span>...
            </p>
            <p>
              <span>La formation DUT Techniques de gestion Commerciale</span> est organisée autour de <span>compétence en Techniques de gestion Commerciale </span> complété par des connaissances générales permettent aux étudiants une insertion professionnelle immédiate, ou une vers d'autres l'enseignement supérieur, Master spécialisé ou Grandes écoles.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Former en 2 ans des collaborateurs opérationnels dans les différents services commerciaux des entreprises industrielles, service ou de la distribution.
            </p>
            <p>
              La formation permet d'acquérir un bon niveau tant pratique que théorique en <span>marketing, vente, économie, droit, comptabilité, informatique</span>, sans négliger les disciplines de culture générale <span>techniques d'expression, anglais, maths/stats</span>...
            </p>
            <p>
              Le titulaire du DUT <span>Techniques de gestion Commerciale</span> est amené à exercer des <span>fonctions commerciales et marketing au sein d'entreprises de transports, de distribution, de l'industrie, d'assurance et des banques</span>. Plus précisément, assure des activités très diverses <span>vente, mercatique, publicité, promotion</span>...
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/TGC.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
