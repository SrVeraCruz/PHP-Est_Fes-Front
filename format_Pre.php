...
<head>
  ...
  <title>Formation | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#format_pre" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Formaton start -->
    <section class="section filiere section-mixins" id="format_pre">
      <div class="headline">
        <h1>Formation</h1>
        <h2>Les Formations Académiques</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>L'Ecole Supérieure de Technologie est un établissement <span>UNIVERSITAIRE</span>.
              Elle fait partie de l'université Sidi Mohamed Ben Abdellah.
              Le diplôme principal délivré est le <span>DUT</span> : Diplôme Universitaire de Technologie, qui est parfaitement bien reconnu et hautement apprécié.
              Depuis l'année universitaire <span>2014-2015</span> l'EST est habilitée a délivré le diplôme de licence professionnelle .
            </p>
            <p>
              Les formations dispensés sont variées et en parfaite adéquation avec les besoins du monde socio-économique.
              <span>Elles permettent: Une insertion rapide dans le tissu socioprofessionnel, Une rapide évolution de carrière, Une éventuelle poursuite des études</span>
            </p>
            <p>
              Le personnel d'encadrement riche et varié est composé d'enseignants, des ingénieurs, et des enseignants chercheurs couvrant tous les cadres (PES, PH, PESA).
            </p>
            <p>
              Le corps étudiant est constitué de jeunes bacheliers, nationaux et étrangers couvrant toutes les séries du baccalauréat.
            </p>
            <p>
              L'EST est avant tout un établissement universitaire à <span>finalité professionnalisant</span>.
            </p>
            <p>
              Absolument nécessaire, la relation avec les professionnels ne se limite pas à leur contribution à l'enseignement, les projets de fin d'études, les études de cas et l'encadrement des stages en entreprises, les partenaires socio-économique siègent aussi dans les jurys de délibération, le conseil de l'école et dans toutes les commissions du conseil.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              <span>Objectifs prioritaire : insertion dans la vie active</span>
            </p>
            <p>
              Il est essentiel que les candidats à l'EST en soient conscients car cela implique une grande motivation pour la formation technologique et professionnalisante à laquelle ils postulent.
            </p>
            <p>
              Certes, <span>l'EST</span> permet d'acquérir une solide formation de base , mais c'est avant tout une formation professionnelle de techniciens supérieurs de haut niveau pour les titulaires de <span>DUT</span> et de cadre technique pour les titulaire de Licence Professionnelle(LP) qui permet d'être en mesure de trouver un emploi qualifié dans des créneaux porteurs de l'économie nationale, voire contribuer à la création d'entreprises.
            </p>
          </div>
        </div>
      </div>
    </section>
    <!-- Section Formation end -->
  </main>
  <!-- Main end -->
