...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_ge" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_ge">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Génie Electrique</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Le diplomé de la filière <span>Génie Electrique</span> a essentiellement pour vocation de travailIer comme technicien dans
              les domaines: <span>Etudes</span> et <span>développement</span>, (<span>
              conception et
              reillage, assistance technique -Maintenance, assurance qualité et services, voire du commerce - L'industrialisation et la production L'organisation, réalisation et mise au point de projet (coordination d'une équipe, organisation du travail, controle et paramétrage</span>,...)
            </p>
            <p>
              <span>Poursuite des études</span>
              Le cursus de formation de la filière <span>Génie Electrique</span>, comportant un ensemble de modu acquérir à l'étudiant des connaissances, saires à la poursuite des études en: <span>Licences Professionelles</span> - <span>Ecoles d'Ingenieurs</span>.
        ...
        <div class="box">
          ...
          <div class="box-content">
            <p>
              La filière <span>Génie Electrique</span>, organisée en quatre semestres est sanctionnée par un diplôme Universitaire de Technoligie <span>(DUT)</span>. Cet enseignement a pour objectif de former des techniciens supérieurs de haut niveau en 2 ans, capables d'occuper des emplois clés dans le secteur industriel. C'est une formation de large spectre couvrant tous les domaines de:
            </p>
            <ul>
              <li><p>L'électronique;</p></li>
              <li><p>L'électrotechnique et l'électronique de puissance;</p></li>
              <li><p>La production le transport et la distribution de l'énérgie éléctrique;</p></li>
                <li><p>L'asservissement et la régulation des systèmes;</p></li>
                <li><p>Les systèmes automatisés;</p></li>
                <li><p>L'informatique des systèmes industriels;</p></li>
            </ul>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/GE.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
