...
<head>
  ...
  <title>Espace etudiant | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <!-- Section Espace Etudiant start -->
    <a href="#ent" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    
    <section class="section" id="esp_et">
      <div class="headline">
      ...
      <div class="box-container">
        <div class="box">
          <img src="./img/est_etudiant.png" alt="">
          <div class="content-Box">
            <h3>ENT</h3>
            <a href="./esp_et_ENT.php">espace numerique de travail <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/est_diplome_universitaire.jpeg" alt="diplome_universitaire">
          <div class="content-Box">
            <h3>DU</h3>
            <a href="./404.php">diplome universitaire <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/est_elearning.jpg" alt="E-Learning">
          <div class="content-Box">
            <h3>E-L</h3>
            <a href="./ElearningLogin.php">E-Learning <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/est_calendar_semaine.webp" alt="calendrier">
          <div class="content-Box">
            <h3>CS</h3>
            <a href="./esp_et_CS.php">calendrier des semaines <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/est_emploi_temps.png" alt="emploi_temps">
          <div class="content-Box">
            <h3>ET</h3>
            <a href="./404.php">emploi du temps <span>2022-2023</span> <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/est_evolution_effectifs.avif" alt="evolution_effectifs">
          <div class="content-Box">
            <h3>EEF</h3>
            <a href="./404.php">evolution des effectifs <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/est_cours_etudiant.png" alt="cours_etudiant">
          <div class="content-Box">
            <h3>CE</h3>
            <a href="./esp_et_CE.php">cours aux etudiants <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/est_suivi_laureats.png" alt="suivi_laureats">
          <div class="content-Box">
            <h3>SL</h3>
            <a href="./suivi.php">suivi des laureats <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
      </div>
    </section>
