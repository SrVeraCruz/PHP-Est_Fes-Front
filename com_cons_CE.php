...
<head>
  ...
  <title>Conseil-Ecole CE | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#cc_ce" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Commission-Conseil start -->
    <section class="section depertements section-mixins" id="cc_ce">
      <div class="headline">
        <h1>Conseil</h1>
        <h2>Conseil de L'Ecole</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          <div class="titre-container">
            <h2>Membres de droit</h2>
          </div>
          <div class="box-content">
            <div>
              <h3>Directeur</h3>
              <div>
                <p>Professeur Ali BENBASSOU</p>
              </div>
            </div>
            <div>
              <h3>Directeur adjoint</h3>
              <div>
                <p>Professeur Abdelaziz EL GHZIZAL</p>
              </div>
            </div>
            <div>
              <h3>Secrétaire Général</h3>
              <div>
                <p>Monsieur LAHROURI SALAH</p>
              </div>
            </div>
          </div>
        </div>
        <div class="box">
          <div class="titre-container">
            <h2>Représentant le Secteur Socioéconomique</h2>
          </div>
          <div class="box-content">
            <div>
              <h3>Directeur régional adjoint du secteur bancaire</h3>
              <div>
                <p>Mr Bader Masmoudi Fayez</p>
              </div>
            </div>
            <div>
              <h3>Agence Régionale d'Exécution des Projets - Région Fès-Meknes</h3>
              <div>
                <p>Mr Youssef Zayani Amour</p>
              </div>
            </div>
            <div>
              <h3>Directeur régional de l'artisanat</h3>
              <div>
                <p>Mr Abderahim Belkhayat</p>
              </div>
            </div>
            <div>
              <h3>Directeur régional de l'ONEE</h3>
              <div>
                <p>Mr Hassan Arradi</p>
              </div>
            </div>
          </div>
        </div>
        <div class="box">
          <div class="titre-container">
            <h2>Chefs de départements</h2>
          </div>
          <div class="box-content">
            <div>
              <h3>Génie Mécanique et Productique et Maintenance Industrielle</h3>
              <div>
                <p>Mr Belmir Fouzi</p>
              </div>
            </div>
            <div>
              <h3>Génie Electrique et Informatique</h3>
              <div>
                <p>Mr RACHID ELBACHTIRI</p>
              </div>
            </div>
            <div>
              <h3>Génie des Procédés</h3>
              <div>
                <p>Mme OUAZZANI KAMAR</p>
              </div>
            </div>
            <div>
              <h3>Techniques de Sciences de Gestion</h3>
              <div>
                <p>Mr ALAOUI ISMAILI ABDERRAHMAN</p>
              </div>
            </div>
          </div>
        </div>
        <div class="box">
          <div class="titre-container">
            <h2>Membres élus représentant des professeurs</h2>
          </div>
          <div class="box-content">
            <div>
              <h3>PES</h3>
              <div>
                <p>Mr AMEGOUZ DRISS</p>
                <p>Mr JAMAL BELKADID</p>
                <p>Mr KHALIL MAALMI</p>
                <p>Mr YOUSSEF MOURAD</p>
              </div>
            </div>
            <div>
              <h3>PH</h3>
              <div>
                <p>Mr BENSLIMANE MOHAMED</p>
                <p>Mr OUDASSER ABDERRAHMANE</p>
                <p>Mme EL IDRISSI TISSAFI AMINA</p>
                <p>Mr AIT MSAAD ABDELOUAHAD</p>
              </div>
            </div>
            <div>
              <h3>PESA</h3>
              <div>
                <p>Mme BANOUAR OUMAYMA</p>
                <p>Mr ARIF JABER</p>
                <p>Mme ASMAE BELKHOU</p>
              </div>
            </div>
          </div>
        </div>
        <div class="box">
          <div class="titre-container">
            <h2>Membre élus représentant le personnel administratif</h2>
          </div>
          <div class="box-content">
            <div>
              <h3>Technicien</h3>
    ...
    <!-- Section Commission-Conseil end -->
  </main>
  <!-- Main end -->
