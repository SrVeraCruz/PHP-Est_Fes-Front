...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#regle_inter" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Reglement start -->
    <section class="section filiere section-mixins" id="regle_inter">
      <div class="headline">
        <h1>Reglement</h1>
        <h2>Reglement Interieur De L'internat</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>
              L'internat est facultatif et est accordé en priorité aux étudiants venant des villes éloignées. Il peut être également accordé aux étudiants originaires de Fès, dans la limite des places disponibles.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Le montant annuel de la pension est fixé à 1140 DH. Le paiement est annuel et payable d'avance. En cas de désistement, le loyer ne peut être restitué au locataire. Le recouvrement des sommes dont l'étudiant serait redevable envers l'administration peut être poursuivi par toutes voies de droit.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Le droit d'occupation est strictement personnel et incessible. Aucun changement de chambre ne peut être effectué sans autorisation préalable de l'administration.
            </p>
            <p>
              Tout locataire est tenu de présenter sa carte de résident à tout contrôle effectué par l'administration.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Il est strictement interdit de fumer dans les chambres et espaces communs de l'internat. De même l'usage de tout produit illicite expose à des sanctions disciplinaires pouvant aller jusqu'à l'exclusion définitive de l'internat.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Les locataires sont tenus responsables de l'état des lieux de leur chambre et des espaces communs.
              Il est demandé aux étudiants de veiller à la propreté de leur chambre et de leur pavillon et d'éviter d'abîmer leurs équipements (murs, portes, fenêtres, placards, mobilier, installations sanitaires et électriques,…etc).
            </p>
          </div>
        </div>
        <div class="box">
        ...
        <div class="box-content">
          <p>
            Il est formellement interdit de procéder à une quelconque modification ou à une utilisation non réglementaire des installations électriques des chambres.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            Toute dégradation doit être réparée aux frais communs des intéressés, à moins que l'auteur n'en soit connu, auquel cas les frais sont à la charge de ce dernier.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            Les étudiants sont tenus de respecter les règles de vie communautaire et d'éviter tout ce qui peut gêner ou contrarier leurs camarades.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            Les étudiants internes ne doivent recevoir dans leur chambre aucune personne étrangère à l'Ecole.
            En outre, il est strictement interdit pour les garçons de se rendre dans le pavillon des filles et vice-versa.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            Chaque étudiant est responsable de ses biens propres dont il doit assurer lui-même la sauvegarde. L'administration n'est nullement responsable des pertes ou vols qui peuvent se produire dans les chambres.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            Les étudiants doivent laisser libre accès à leur chambre à l'occasion de l'entretien périodique des locaux et du mobilier.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            L'accès au restaurant est interdit à toute personne étrangère sans l'autorisation de l'administration.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            Les étudiants qui le souhaitent peuvent cuisiner dans les salles réservées à cet effet, mais ne doivent absolument pas le faire à l'intérieur des chambres. L'usage des bouteilles de gaz est strictement interdit de même pour tout produit inflammable ou explosif.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            Les portes des pavillons de l'internat sont fermées à 11 heures du soir, du lundi au vendredi, et à minuit, les samedi, dimanche et jours fériés.
          </p>
        </div>
      </div>
      <div class="box">
        ...
        <div class="box-content">
          <p>
            Toute infraction au règlement intérieur de l'internat expose son auteur à des sanctions disciplinaires pouvant aller jusqu'à l'exclusion définitive.
          </p>
        </div>
      </div>
      <div class="box">
