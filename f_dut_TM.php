...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Techniques de Managment</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_tm" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_tm">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Techniques De Managment</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>La formation DUT en <span>Techniques De Managment</span> a pour mission de transmettre à ses lauréats des compétences    
              techniques et etier dans le secteur Informatique a savoir: <span>Secteurs bancaires, finacier et d'assurances Administrations  publiques (impôts, douanes...) Filiares de production et de commercialisation des Airmes multinationales, Places financières offshore</span>...
              
            </p>
            <p>
              <span>La formation DUT Techniques De Managment</span> est organisée autour de <span>compétence en Techniques De Managment</span> complété par des connaissances générales permettent aux étudiants une insertion professionnelle immédiate, ou une vers d'autres l'enseignement supérieur, Master spécialisé ou Grandes écoles
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              <span>Former des techniciens supérieurs en techniques de management</span> capables de résourdedes <span>problèmes économiques, comptables, fiscaux et financiers de l'entreprise, (former desprofils adaptés aux besoins et aux attentes dumarché de travail).</span>
            </p>
            <p>
              <span>Développer I'imagination créatrice</span>, l'ésprit d'analyse et de synthèse Appréhender et valoriser les nouvelles données de la mondialisation (offshoring). Promouvoir l'esptit export, assurer la conduite et le suivi d'un projet...
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/TM.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
