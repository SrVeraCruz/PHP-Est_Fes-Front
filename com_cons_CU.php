...
<head>
  ...
  <title>Conseil-Ecole CU | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#cc_cu" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Commission-Conseil start -->
    <section class="section depertements section-mixins" id="cc_cu">
      <div class="headline">
        <h1>Conseil</h1>
        <h2>Conseil d'université</h2>
      </div>
