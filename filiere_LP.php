...
<head>
  ...
  <title>Filiere LP | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <!-- Section Filiere LP start -->
    <a href="#f_lp" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    
    <section class="section mix_filiere" id="f_lp">
      <div class="headline">
        <h1>Filiere</h1>
        <h2>LP</h2>
      </div>
      ...
      <div class="box-container">
        <div class="box">
          <div>
            ...
            <a href="./f_lp_LOG.html">Logistique</a>
          </div>
        ...
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_lp_MEEB.html">Maintenance Electroniques Des Equipements Biomedicaux(MEEB)</a>
          </div>
          <p>Licence Professionnelle</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_lp_PIM.html">Production Industrielle(PIP/PIM)</a>
          </div>
          <p>Licence Professionnelle</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_lp_QAGRO.html">Qualité En Agroalimentare(QAGRO)</a>
          </div>
          <p>Licence Professionnelle</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_lp_TNR.html">Tannerie Et Idustrie Du Cuir</a>
          </div>
          <p>Licence Professionnelle</p>
        </div>
        <div class="box">
          <div>
            <i class="fa-solid fa-graduation-cap"></i>
            <a href="./f_lp_TEREE.html">Technologies Des Energies Renouvables et de L'Efficacité Energétique(TEREE)</a>
          </div>
          <p>Licence Professionnelle</p>
        </div>
      </div>
