...
<body class="body">
  ...
  <main class="main">
    ...
    <section class="section filiere section-mixins" id="format_scorg">
      <div class="headline">
        <h1>Espace N-T</h1>
        <h2>Bienvenue sur votre Environnement Numérique de Travail</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>L'Université Sidi Mohamed Ben Abdellah met à disposition de son staff (enseignants, étudiants et staff administratif)   
              un outil de communication et de collaboration sécurisé et simple à utiliser.
            </p>
            <p>
              il vous sera possible, selon votre profil, de :
            </p>
            <ul>
              <li>S'informer sur les derniers événements  de l'université,</li>
              <li>Lire et envoyer des messages électroniques,</li>
              <li>Disposer d'un agenda éléctronique en ligne,</li>
              <li>Consulter les annuaires des enseignants-chercheurs,</li>
              <li>Consulter vos derniers documents de travail dans votre espace,</li>
              <li>Consulter vos notes, vos résultats et votre emploi du temps,</li>
              <li>
                Demander vos attestations d'inscriptions, relevés de notes, retrait des diplômes du baccalauréat, attestation de travail,attestation de salaire,
              </li>
              <li>Suivre l'actualité,</li>
              <li>et bien d'autres outils...</li>
            </ul>
            <p>
              L'ENT vous permet, à partir d'un navigateur, d'accéder à ces services, depuis n'importe quel lieu et à n'importe quel moment. Il suffit de disposer d'un équipement connecté à l'internet (depuis votre domicile, le réseau de l'université ou tout autre point d'accès) <span>et un compte de messagerie académique de l'USMBA</span>.
            </p>
            <p>
              Il est accessible en mode personnalisé dès que vous vous êtes authentifié. Vous pourrez accéder aux services à votre disposition et passer de l'un à l'autre sans avoir à fournir à nouveau vos codes d'accès. La connexion à votre environnement numérique de travail suffit pour utiliser ces services.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            ...
            <p>
              Si vous avez perdu vos identifiants de connexion ou vous rencontrez un problème de connexion, veuillez contacter le service helpdesk universitaire à l'adresse: <span>support@usmba.ac.ma</span>
            </p>
          </div>
        </div>
      </div>
