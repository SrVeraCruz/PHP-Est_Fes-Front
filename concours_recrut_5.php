...
<body class="body">
  ...
  <main class="main">
    ...
    <a href="#conc_rec_5" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    
    <section class="section" id="conc_rec_5">
      <div class="headline">
        <h1>Concours</h1>
      </div>
      ...
      <div class="box-container">
        <div class="box">
          <a href="./filieres/conc_rec_5.1.pdf">
            اعلان
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_5.2.pdf">
            اللائحة الاولى
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_5.3.pdf"> 
            اللائحة الثانية   
          </a>
        </div>
      </div>
