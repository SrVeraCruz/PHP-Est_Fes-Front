...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Qualité En Agroalimentare(QAGRO)</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#lp_qagro" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="lp_qagro">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>LP -  Qualité en Agroalimentaire</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            ...
            <p>
              Le contenu des modules dispensés en S5 et S6 repond a un enchainement et une
              progression logique afin que l'étudiant puisse suivre et assimiler les différentes matières sans difficultés...
        ...
        <div class="box">
          ...
          <div class="box-content">
            <p>
              La Licence Professionnelle en alternance "Qualité en agroalimentaire" est ouverte depuis septembre 2014, à l'Ecole Supérieure de Technologie de Fès (EST). Ce programme a pour objectif de renforcer le caractère professionnalisant des Ecoles Supérieures de Technologie au Maroc.
            </p>
            <p>
              C'est la première fois au Maroc, qu'un tel type de formation universitaire est mis en place en partenariat étroit et effectif entre l'EST et ses partenaires industriels. L'alternance de périodes de formation entre l'EST et l'entreprise permet a L'étudiant d':
            </p>
            <ul>
              <li>
                Avoir un champ favorable d'application des connaissances acquises,
              </li>
              <li>
                Acquérir des savoir-faire,
              </li>
              <li>
                Acquérir la maturité et l'autonomie de manière progressive,
              </li>
              <li>
                Apprendre un métier,
              </li>
              <li>
                Entrer dans le monde professionnel de façon graduelle...
              </li>
            </ul>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/LPQAGRO.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
