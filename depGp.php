...
<body class="body">
  ...
  <main class="main">
    ...
    <section class="section depertements section-mixins" id="dut_gp">
      <div class="headline">
        <h1>Département</h1>
        <h2>Génie des Procédés</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <div>
              <h3>PES</h3>
              <div>
                <p>LOUKILI MOHAMMED</p>
                <p>BENTAMA JILALI</p>
                <p>LAHSINI AHMED</p>
                <p>KHERBECHE ABDELHAK</p>
                <p>LOUKILI ABDELLATIF</p>
                <p>ZERROUQ FARID</p>
                <p>LAKHLIAI ZAKIA</p>
                <p>MOURAD YOUSSEF</p>
                <p>BELKHOU RAJAE</p>
                <p>CHAOUNI BENABDALLAH AZIZ</p>
                <p>ANIS KHALIL</p>
                <p>OUAZZANI KAMAR</p>
                <p>ADDAOU ABDELLAH</p>
                <p>LAAJEB ALI</p>
                <p>ENNABILI ABDESLAM</p>
                <p>JAMIL ABDELMAJID</p>
              </div>
            </div>
            <div>
              <h3>PH</h3>
              <div>
                <p>EL GOURI MUSTAPHA</p>
                <p>BOUSLAMTI RABIA</p>
                <p>LAIRINI SANAE</p>
                <p>MEJBAR FATIHA</p>
                <p>EL IMACHE AHDE</p>
                <p>ALLOUHI AMINE</p>
                <p>AIT MSAAD ABDELOUAHAD</p>
              </div>
            </div>
            <div>
              <h3>PESA</h3>
        ...
        <div class="box">
          ...
          <div class="box-info">
            ...
            <p>Chef De Département: <span>Ouazzani Kamar</span></p>
            <p>Email: <a href="mailto:gp@usmba.ac.ma">gp@usmba.ac.ma</a></p>
          </div>
        </div>
      </div>
    </section>
