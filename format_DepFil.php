...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#format_depfil" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Formaton start -->
    <section class="section filiere section-mixins" id="format_depfil">
      <div class="headline">
        <h1>Formation</h1>
        <h2>Département, Filières et Options</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Les enseignements sont dispensés au sein des <span>Départements de l'établissement</span>.
            </p>
            <p>
              Le département est une unité d'enseignement et de recherche Dotée des moyens humains et matériels nécessaires à son fonctionnement et d'une large autonomie de gestion. <span>Il est dirigé par un chef de département qui veille au bon déroulement de l'activité pédagogique, de recherche et de partenariat</span>.
            </p>
          </div>
        </div>
        <div class="box">
          <div class="titre-container">
            <h2>Filieres et Options</h2>
          </div>
          <div class="box-info">
            <a href="./img/formationDUT.png" class="btn">Voir Les Filières DUT  <i class="fa fa-angle-right"></i></a>
          </div>
          <div class="box-info">
            <a href="./img/formationLP.png" class="btn">Voir Les Filières LP  <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
