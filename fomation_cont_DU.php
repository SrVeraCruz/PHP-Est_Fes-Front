...
<head>
  ...
  <title>Formation continue | l'EST de Fes</title>
...
<body class="body">
  ...
  <main class="main">
    ...
    <a href="#fc_du" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    
    <section class="section" id="fc_du">
      <div class="headline">
        <h1>Concours</h1>
      </div>
      ...
      <div class="box-container">
        <div class="box">
          <a href="./filieres/form_cont_1.pdf">  
            Appel à candidature ET liens d'inscription
          </a>
        </div>
        <div class="box">
          <a href="./filieres/form_cont_2.pdf">  
            Les Systèmes de Production, Pilotage et Maintenance (SPPM) Bac + 5Appel à candidature ET liens d'inscription
          </a>
        </div>
        <div class="box">
          <a href="./filieres/form_cont_3.pdf">         
            Ingénierie des Systèmes Electriques Industriels (ISEI) Bac + 3
          </a>
        </div>
        <div class="box">
          <a href="./filieres/form_cont_4.pdf">
            Management Qualité : Cas des Entreprises Agroalimentaires (MQEA) Bac + 3
          </a>
        </div>
        <div class="box">
          <a href="./filieres/form_cont_5.pdf">
            Supply Chain Management (SCM) Bac + 5
          </a>
        </div>
      </div>
      </div>
