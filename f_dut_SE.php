...
<head>
  ...
  <title>Filiere | l'EST de Fes</title>
...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Système Embarqués</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_se" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_se">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Systèmes Embarqués</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>La formation DUT en <span>Systèmes Embarqués</span> a pour mission de transmettre à ses lauréats des compétences techniques et etier dans  
              le secteur industriel a savoir: <span>
                Le développement et la conception des Systèmes embarqués,
                La maîtrise et la maitenance des systèmes aéronautiques et automobile,
                L'automatisation, la régulation industrielle et la commande des procédés, La sécurité des systèmes,
                La conception et le dimensionnement d'installations industrielles, La gestion des projets
              </span>...
              
            </p>
            <p>
              <span>La formation DUT SE</span> est organisée autour de <span>compétence en éléctronique et informatique embarquéee</span> complété par des connaissances générales permettent aux étudiants une insertion pro essionnelle immédiate, ou une vers d'autres l'ens Ignement supérieur.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Aujourd'hui, la majorité des ordinateurs sont embarqués, on les trouve dans les téléphones portables, les consoles de jeux, les voitures, les avions, les équipements médicaux; les appreils ménagers, les robots, etc...
            </p>
            <p>
              L'objectif de la Filière Systèmes Embarqués est de former des techniciens supérieurs dans le domaine des <span>systèmes embarqués de haut niveau technique et des compétences polyvalentes leurs permettant de seconder les ingénieurs dans le domaine de l'aéronotique, de l'automobile, médical, domotique ou encore multimédia</span>
              <span>La filière Systèmes Embarqués</span> organisée <span>en quatre semestres</span> est sanctionnée par un <span>Diplôme Universitaire de Technologie (DUT)</span>.
              Cette formation apporte aux étudiants des connaissances théoriques dans le domaine <span>d'électronique et de l'informatique embarquée</span> qui sont complétées et approfondies par de nombreux travaux pratiques et projets. Les thématiques abordées couvrent un specte large, depuis le matériel (langages de sescription matériel, architectures reconfigurables, support d'exécution) jusqu'aux aspects logiciels (programmation d'un système à micro-processeur, compilation, programmation mobile) en incluant également des connaissances <span>en automatiques, automatismes Industriels et réseaux locaux</span>.
        ...
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/SE.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
