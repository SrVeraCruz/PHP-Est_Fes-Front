...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_info" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_info">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Génie Informatique</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Le diplomé de la filière <span>Génie Informatique</span> a essentiellement pour vocation de travailIer comme technicien dans
                les domaines: <span>Etudes</span> et <span>développement,
                Concepteur, réalisateur et ou intégrateur de solutions informatiques
                L'Embarqué et application mobile - Le Conseil en Technologies,
                Assurer une veille technologique,
                Rédiger des notices d'installation,
                Définir des besoins fonctionnels, Former les utilisateurs et développer des solutions.</span>
            </p>
            <p>
              <span>Possibilités de poursuite des études au Maroc et à l'étranger: Ecoles d'ingenieurs</span>
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              La filière <span>Génie Informatique</span>, organisée en quatre semestres est sanctionnée par un diplôme Universitaire de Technoligie <span>(DUT)</span>. Cet enseignement a pour objectif de former des techniciens supérieurs de haut niveau en 2 ans, capables d'occuper des emplois clés dans le secteur informatique. C'est une formation de large spectre avec l'objectif de:
            </p>
            <ul>
              <li><p>Connaitre et utiliser des méthodes, des techniques et des outils;</p></li>
              <li>
                <p>
                  Prendre en compte les aspects liés aux usages de l'information et aux évolutions des organisations et des technologies
                </p>
              </li>
              <li><p>Analyser, concevoir et développer des systèmes et des applications repondant aux besoins des organisation;</p></li>
                <li><p>S'appuyer sur des normes et des standards;</p></li>
                <li><p>Les systèmes automatisés;</p></li>
                <li><p>L'informatique des systèmes industriels informatiques et sectoriels;</p></li>
            </ul>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/INFO.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
