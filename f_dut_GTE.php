...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Génie Thermique et Energétique</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_gte" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_gte">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Génie Thermique Et Energétique</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>La formation DUT en <span>Génie Thermique Et Energétique</span> a pour mission de transmettre à ses lauréats des compétences
              techniques et etier dans le secteur Informatique a savoir: <span> Technico-commerciaux et conseillers techchauffage, ventilation et climatisation Conducteurs de travaux et responsables d'exploitation de chauffage et de climatisation Technique, Maintenance et gestion d'installations thermiques, Techniciens d'études et d'essais dans les entreprises liées à l'aéronautique et l'automobile. Conseiller (expertise, conseil, prescription)</span>...
              
            </p>
            <p>
              <span>La formation DUT Génie Thermique Et Energétique</span> est organisée autour de <span>compétence en Génie Thermique Et Energétique</span> complété par des connaissances générales permettent aux étudiants une insertion professionnelle immédiate, ou une vers d'autres l'enseignement supérieur.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Centrales thermiques, parcs éoliens, climatisation et ventilation des bâtiments, chaudières, machines frigorifiques, moteurs de voitures, turboréacteurs... L'énergie est présente partout.
            </p>
            <p>
              Qu'elle soit thermique, chimique, frigorifique, mécanique, électrique,nouvelle et/ou renouvelable, elle a sa place dans tous les domaines tant sur le plan domestique que sur le plan industriel. Dans cette logique, la formation Génie Thermique et Energétique vise à former des techniciens supérieurs dans tous les domaines liés à la production, à l'utilisation...
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/GTE.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
