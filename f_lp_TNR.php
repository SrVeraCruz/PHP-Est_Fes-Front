...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Tannerie Et Idustrie Du Cuir</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#lp_tnr" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="lp_tnr">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>LP - Tannerie et Industrie de Cuir</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Le contenu des modules dispensés en S5 et S6 repond a un enchainement et une
        ...
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Cette filière répond aux besoins du secteur du cuir qu soutient la mise en place d'une filière de formation professionnalisante au sein de l'Université Sidi Mohamed Abdellah, à l'Ecole Supérieure de
              Technologie de Fès. Les lauréats dans le domaine des Tanneries et Industrie du Cuir, vont contribuer à l'amélioration des conditions de travail des tanneurs de la région de Fès-Meknès et d'autres villes du royaume. La formation de cette licence professionnelle, se fera en partie, en alternance et a pour objectif de former des professionnels dans le domaine de tannage.
            </p>
            <p>
              Les avantages de la formation par alternance sont nombreux. Entre autre, elle permet à l'étudiant de:
            </p>
            <ul>
              <li>
        ...
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/LPTNR.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
