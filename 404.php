...
<head>
  ...
  <title>404 - not found | l'EST de Fes</title>
...
<body class="body">
      ...
      <ul>
        ...
        <li class="scrollHeader">
          ...
          <div class="nav_hover" id="recherche">
            <i class="fa fa-angle-left closeListHover1"></i>
            <ul>
              <li><a href="#">CED STSM</a></li>
              <li><a href="./recherche_SJESG.php">CED SJESG</a></li>
              <li>
                <div class="children1">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#404" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section 404 start -->
    <section class="section  construction" id="404">
      <div class="headline">
        <h1>Construction</h1>
      </div>
