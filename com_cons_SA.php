...
<head>
  ...
  <title>Conseil-Ecole SA | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#cc_sa" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Commission-Conseil start -->
    <section class="section depertements section-mixins" id="cc_sa">
      <div class="headline">
        <h1>Conseil</h1>
      ...
      <div class="boxContainer">
        ...
        <div class="box">
          ...
          <div class="box-content">
            <div>
              <h3>Directeur adjoint à la formation</h3>
              <div>
                <p>Mr Abdelaziz EL GHZIZAL</p>
              </div>
            </div>
            <div>
              <h3>Directeur adjoint à la recherche et la coopération</h3>
              <div>
                <p>Mr Loukili Abdellatif</p>
              </div>
            </div>
            <div>
              <h3>Division des affaires administratives et institutionnelles</h3>
              <div>
        ...
        <div class="box">
          ...
          <div class="box-content">
            <div>
              <h3>Chef de Service Financier</h3>
              <div>
                <p>Mr RACHID MEZOUAGUI</p>
              </div>
            </div>
            <div>
              <h3>Chef de Service des affaires administratives (A. institutionnelles , RH, patrimoine , logistique)</h3>
              <div>
                <p>Mme Khadija Bouardi</p>
              </div>
            </div>
            <div>
              <h3>Chef de Service de la recherche, de la coopération, du partenariat et des stages</h3>
              <div>
                <p>Mr Ismail Boubakri</p>
              </div>
            </div>
            <div>
              <h3>Chef de Service des affaires estudiantines des statistiques et de suivi de l'insertion des lauréats</h3>
              <div>
                <p>Mr Hassan Boumakhled</p>
              </div>
            </div>
            <div>
              <h3>Chef de Service Informatique</h3>
              <div>
                <p>Mr Amrani Youssef</p>
              </div>
            </div>
          </div>
        </div>
