<?php 
  session_start();
  if(isset($_SESSION['emailNoValid']) == false) {
  ...
  <main class="main">
    ...
    <section class="section newletter" id="newLtAll">
      ...
      <div class="boxContainer">
        <p>Votre email n'est pas inscrit dans l'ecole.</p>
        <p>Voulez vous contacter l'administration d'ecole: <a href="mailto:support.est@usmba.ac.ma">support.est@usmba.ac.ma</a></p>
      </div>
    </section>
    <!-- Section Newsletter -->
  </main>
