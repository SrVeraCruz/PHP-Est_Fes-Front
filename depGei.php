...
<head>
  ...
  <title>Departement | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#gei" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Depertement start -->
    <section class="section depertements section-mixins" id="gei">
      <div class="headline">
        <h1>Département</h1>
        <h2>Génie Electrique et Informatiqaue</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <div>
              ...
              <div>
                <p>BENBASSOU ALI</p>
                <p>BENSLIMANE RACHID</p>
                <p>EL BACHTIRI RACHID</p>
                <p>MOHA OUCHANE MUSTAPHA</p>
                <p>FRIKH BOUCHRA</p>
                <p>BENBRAHIM MOHAMMED REDA</p>
                <p>EL GHZIZAL ABDELAZIZ</p>
                <p>BELKADID JAMAL</p>
                <p>MAALMI KHALIL</p>
                <p>DEROUICH AZIZ</p>
              </div>
            ...
            <div>
              <h3>PH</h3>
              <div>
                <p>EL HAMMOUMI KARIMA</p>
                <p>EL GHAZI MOHAMMED</p>
                <p>QESMI REDOUANE</p>
            ...
            <div>
              ...
              <div>
                ...
                <p>BANOUAR OUMAYMA</p>
                <p>FRI ABDELAZIZ</p>
                <p>TAOUSSI MOHAMMED</p>
                <p>HANAFI AHMED</p>
                <p>BOUSSETTA MOHAMMED</p>
                <p>HACHMOUD ADIL</p>
                <p>JAI OTMAN</p>
                <p>TMIMI MEHDI</p>
                <p>MOUTAKKI ZAKARIA</p>
                <p>LOTFI EL MEHDI</p>
              </div>
            </div>
            <div>
        ...
        <div class="box">
          ...
          <div class="box-info">
            <p>Date de Création: <span>1986</span></p>
            <p>Chef De Département: <span>El Bachtiri Rachid</span></p>
            <p>Email: <a href="mailto:ge@usmba.ac.ma">ge@usmba.ac.ma</a></p>
          </div>
        </div>
      </div>
    </section>
    <!-- Section Depertement end -->
  </main>
  <!-- Main end -->
