...
<head>
  ...
  <title>Concours et recrutements | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <!-- Section Concours et recrutements start -->
    <a href="#conc_rec" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    
    <section class="section" id="conc_rec">
      <div class="headline">
        <h1>Concours</h1>
      </div>
      <h1>Concours et recrutements</h1>
      <div class="box-container">
        <div class="box">
          <a href="./filieres/conc_rec_1.pdf">
            النتيجة النهائية لمبارة توظيف استاد للتعليم العالى مساعد واحد دورة 21/11/2022 تخصص الرياضيات و الاعلاميات
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_2.pdf">
            النتيجة النهائية لمباراة لتوظيف استاد للتعليم العالى مساعد واحد دورة 29/10/2022 تخصص الاعلاميات (Informatique)
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_3.pdf">
            النتيجة النهائية لمباراة توظيف تقني من الدرجة الثالثة (منصب واحد) دورة 16/10/2022 تخصص : كتابة الإدارة
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_4.pdf"> 
            لائحة المترشحين المقبولين لاجتياز الاختبار الشفوي في مباراة توظيف تقني من الدرجة الثالثة (منصب واحد) دورة 16/10/2022 تخصص : كتابة الإدارة
          </a>
        </div>
        <div class="box">
          <a href="./concours_recrut_5.html">
            لائحة المدعوين لاجتياز الاختبار الكتابى لمباراة لتوظيف تقني من الدرجة الثالثة منصب واحد في تخصص كتابة الإدارة (Secrétariat de Direction)
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_6.pdf">
            اعلان عن مباراة لتوظيف استاد للتعليم العالى مساعد واحد دورة 21/11/2022 تخصص الرياضيات و الاعلاميات
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_7.pdf">
            Avis de concours de recrutement d'un professeur d'enseignement assistant un seul poste (01) le 21/11/2022 spécialité: Informatique et Mathématique
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_8.pdf">
            إعـــــــــــلان عـــن مباراة توظيــــــف تنظم المدرسة العليا للتكنولوجيا بفاس يوم : 16/10/2022 مباراة لتوظيف تقني من الدرجة الثالثة منصب واحد في التخصص التالي: كتابة الإدارة (Secrétariat de Direction)
          </a>
        </div>
        <div class="box">
          <a href="./filieres/conc_rec_9.pdf">
            Avis de concours de recrutement d'un Technicien de 3ème grade un seul poste (01) le 16/10/2022
          </a>
        </div>
      </div>
      </div>
    </section>
    <!-- Section Concours et recrutements end -->
  </main>
  <!-- Main end -->
