...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Génie Industiel et Maintenance</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_aim" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_aim">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Génie Industiel Et Maintenance</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Les techniciens supérieurs en <span>Génie Industriel et Maintenance</span> sont formés pour occuper les postes suivants:
              <span>
                Techniciens supérieurs en maintenance industrielle,
                Responsables du service maintenance,
                Responsables des ateliers d'entretien,
                Responsables des bureux des méthodes et d'ordonnancement,
                Responsables des services informatiques (GMAO),
              </span>
            </p>
            <p>
              Possibilités de poursuite des études au maroc et à l'étranger:
              <span>Licences professionnelles Ecoles d'ingénieurs</span>
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              La filière Génie Industriel et Maintenance (GIM) à vise à former des techniciens supérieurs dans le domaine du <span>Génie Industriel et de la maintenance</span>. Ces	techniciens	polyvalents	seront capables:
              <span>D'intervenir sur les équipements et installations industrielles pour les maintenir en bon état de fonctionnement d'assurer leur disponibilité, fiabilité, maintenabilité et sécurité.</span>
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/GIM.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
