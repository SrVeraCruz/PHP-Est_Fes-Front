...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Génie des Procédés</a></li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_gp" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_gp">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Génie des Procédés</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Les titulaires du DUT <span>Génie des Procédés</span> peuvent intégrer plusieurs secteurs industriels dont <span>
              la chimie, la
                parachimie, la pétrochimie, la métallurgie, le ciment, le textile, le verre, la papier</span>...
              Ils travaillent sur les installations de transformation de la matière à l'échelle <span>industrielle</span> ou <span>semi-industrielle</span>.
              Dans les usines, ils sont responsables de la conduite d'appareils complexes, de chaînes de et contrôlent la bonne exécution des consignes de sécurité.
              Ils sont égalements chargés de travaux de bureaux d'études.
            </p>
            <p>
              <span>Poursuite des études</span> est envisageable en école des Procédés ) et en licence professionnelle (<span>Chimie analytique, chimie industrielle, agroalimentaire</span>...), etc
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              La filière <span>Génie des Procédés (GP)</span> forme des
              techniciens supérieurs <span>Industrie Chimique</span> aptes à intégrer dés la fin de leur formation différents domaines d'industries de transformation de la matière, <span>de fabrication de produits</span> par synthèse chmimique contrôlée ainsi que d'autres secteurs dont l'environnement (<span>traitement et valorisation des effluents, des émissions gazeuzes et des déchets solides</span>), <span>le recyclage des matériaux</span>...          
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/GP.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
