...
<body class="body">
              ...
              <li>
                ...
                <div class="nav_hover2">
                  ...
                  <ul>
                    ...
                    <li><a href="#">Gestion Logistique et Transport</a></li>
                  </ul>
                </div>
              </li>
              <li>
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#dut_glt" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Filiere start -->
    <section class="section filiere section-mixins" id="dut_glt">
      <div class="headline">
        <h1>Filiére</h1>
        <h2>DUT - Gestion Logistique et Transport</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>Les Techniciens Supérieurs en <span>Gestion Logistique et Transport</span> formés pour occuper les postes suivants:        
              <span>Gestionnaire de stocks et gestionnaire d'en Gestionnaire de quai, technico-commercial en transport. Logisticien, gestionnaire de services clients. Déclarant en douane</span>...
            </p>
            <p>
              <span>Sécteurs d'activité:</span> Les zones franches, plateformes, zones logistique Administrations publiques, Professions libérales (transitaires... ), Entreprises industrielles et commerciales.

            </p>
            <p>
              <span>La formation DUT Gestion Logistique et Transport</span> est organisée autour de <span>compétence en Gestion Logistique et Transport</span> complété par des connaissances générales permettent aux étudiants une insertion professionnelle immédiate, ou une vers d'autres l'enseignement supérieur, Master spécialisé ou Grandes écoles.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-content">
            <p>
              Former en 2 ans des collaborateurs opérationnels dans les différents services 
              <span>
                logistiques des entreprises industrielles
              </span>...
            </p>
            <p>
              Le titulaire du DUT <span>Gestion Logistique et Transport</span> est amené à <span>Maîtriser les techniques nécessaires au transport de personnes et de marchandises, Maîtriser les techniques de la gestion des achats, des stocks, des approvisionnements de la protection et de la distribution, Maîtriser les techniques du commerce international</span>, etc...
            </p>
            <p>
              Maîtriser les outils informatiques utilisés dans la gestion des flux. Avoir une bonne connaissance des langues étrangères.
            </p>
            <p>
              Connaître les outils de la qualité et de la sécurité des flux physiques et informationnels.
              Capacité à travailler en équipe et aptitude aux relations humaines et au dialogue.
            </p>
          </div>
        </div>
        <div class="box">
          ...
          <div class="box-info">
            <a href="./filieres/GLT.pdf" class="btn">Voir plus <i class="fa fa-angle-right"></i></a>
          </div>
        </div>
      </div>
    </section>
