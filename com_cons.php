...
<head>
  ...
  <title>Commission-Conseils | l'EST de Fes</title>
...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <!-- Section Commission Conseils start -->
    <a href="#cc" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    
    <section class="section" id="cc">
      <div class="headline">
        <h1>Commission - Conseils</h1>
      </div>
      <h1>EST-Fes <i class="fa-solid fa-graduation-cap"></i></h1>
      <div class="box-container">
        <div class="box">
          <img src="./img/cons_com_conseil_ecole.png" alt="conseil_ecole">
          <div class="content-Box">
            <h3>CE</h3>
            <a href="./com_cons_CE.html">conseil de l'ecole <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/cons_com_commision_scinetifique.png" alt="commision_scinetifique">
          <div class="content-Box">
            <h3>CS</h3>
            <a href="./com_cons_CS.html">Commission scientifique <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/cons_com_commision_permentes.png" alt="commision_permentes">
          <div class="content-Box">
            <h3>CP</h3>
            <a href="./com_cons_CP.html">commissions permentes <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/cons_com_adm.png" alt="Administration">
          <div class="content-Box">
            <h3>SA</h3>
            <a href="./com_cons_SA.html">services administratifs <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
        <div class="box">
          <img src="./img/cons_com_conseil_universite.png" alt="conseil_universite">
          <div class="content-Box">
            <h3>CU</h3>
            <a href="./com_cons_CU.html">conseil d'université <i class="fa-solid fa-location-arrow"></i></a>
          </div>
        </div>
      </div>
    </section>
    <!-- Section Commission Conseils end -->
  </main>
  <!-- Main end -->
