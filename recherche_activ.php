...
<head>
  ...
  <title>Recherche | l'EST de Fes</title>
        ...
        <li class="scrollHeader">
          ...
          <div class="nav_hover" id="recherche">
            ...
            <ul>
              ...
              <li><a href="#">les activités de l'ecole</a></li>
            </ul>
          </div>
        </li>
        <li class="scrollHeader">
      ...
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <p>
              L'École Supérieure de Technologie de Fès Organise la 3ème édition du Congrès Méditerranéen des Télécommunications et Exposition <span>23-24-25 Mars 2012</span>.
            </p>
            <div class="box-info">
              <a href="www.est-usmba.ac.ma/CMT12" class="btn">Site web <i class="fa fa-angle-right"></i></a>
            </div>
            <p>
              L'école supérieure de Technologie de Fès organise un séminaire International le <span>08 Mai 2012</span> à l'amphithéâtre de la Faculté de Médecine et de Pharmacie de Fès -Recyclage et valorisation des déchets.
            </p>
            <div class="box-info">
              <a href="./img/recherche_activ.png" class="btn">Savoir plus <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
        </div>
      </div>
