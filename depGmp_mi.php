...
<body class="body">
  ...
  <!-- Main start -->
  <main class="main">
    <a href="#gmp_mi" class="ancar"><i class="fa-solid fa-angle-down fa-rotate-180"></i></a>
    <!-- Section Depertement start -->
    <section class="section depertements section-mixins" id="gmp_mi">
      <div class="headline">
        <h1>Département</h1>
        <h2>Génie Mécanique et Productique et Maintenance Idustrielle</h2>
      </div>
      <div class="boxContainer">
        <div class="box">
          ...
          <div class="box-content">
            <div>
              <h3>PES</h3>
              <div>
                <p>EL HIMDY ABDELHAK</p>
                <p>AMEGOUZ DRISS</p>
                <p>TALBI ABDENNEBI</p>
                <p>SENHAJI ABDELALI</p>
                <p>BELMIR FOUZI</p>
                <p>KAMOUNI MOHAMED</p>
                <p>EZ-ZEJJARI MOHAMED</p>
                <p>BOUTAHARI SAID</p>
                <p>DAFIR DRISS</p>
                <p>KHATORY ABDELLAH</p>
                <p>HERROU BRAHIM</p>
              </div>
            </div>
            <div>
              ...
              <div>
                <p>ABAROU SAMIR</p>
                <p>EL-MEKKAOUI JAOUAD</p>
              </div>
            </div>
            <div>
              <h3>PESA</h3>
              <div>
                <p>EL KANT NOUR EDDINE</p>
                <p>BOULAAMAYEL BENNASSER</p>
                <p>EL HIMDY ABDELHAK</p>
                <p>EL HIMDY ABDELHAK</p>
                <p>EL HIMDY ABDELHAK</p>
                <p>EL HIMDY ABDELHAK</p>
        ...
        <div class="box">
          ...
          <div class="box-info">
            ...
            <p>Chef De Département: <span>Belmir Fouzi</span></p>
            <p>Email: <a href="mailto:gmp@usmba.ac.ma">gmp@usmba.ac.ma</a></p>
          </div>
        </div>
      </div>
    </section>
